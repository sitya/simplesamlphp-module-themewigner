...
?>
    ...
    <input class="btn btn-primary" type="submit" name="yes" id="yesbutton" value="<?php echo htmlspecialchars($this->t('{consent:consent:yes}')) ?>" />
</form>
...
?>
    <input class="btn btn-danger" type="submit" style="display: inline" name="no" id="nobutton" value="<?php echo htmlspecialchars($this->t('{consent:consent:no}')) ?>" />
</form>
...
function present_attributes($t, $attributes, $nameParent)
{
    ...
    if (strlen($nameParent) > 0) {
        ...
        $str = '<table class="attributes table" ' . $summary . '>';
    } else {
        $parentStr = '';
        $str = '<table id="table_with_attributes"  class="attributes table" '. $summary .'>';
    }
    ...
    foreach ($attributes as $name => $value) {
        ...
        if (preg_match('/^child_/', $nameraw)) {
            ...
            if ($isHidden) {
                ...
                $str .= '<td class="attrvalue" style="display: none;" id="hidden_' . $hiddenId . '">';
            } else {
